...
```
VITE_SUPABASE_URL=https://piiaoucyrlvrodzxwjeh.supabase.co
VITE_SUPABASE_ANON_KEY=sb_publishable_DblZb-R3rmsPTZSKBeXHCw_8GM5B4qh
SUPABASE_SECRET_KEY=YOUR_SUPABASE_SERVICE_ROLE_KEY
```

> Importante: `VITE_SUPABASE_ANON_KEY` es segura para el cliente (frontend). `SUPABASE_SECRET_KEY` es para el servidor (backend/Serverless Functions) y **NUNCA debe exponerse en el frontend** ni subirse a repositorios públicos.
